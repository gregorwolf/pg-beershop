...
`VCAP_SERVICES={"docker-postgres":[{"name":"postgres","label":"postgres","tags":["plain", "db", "relational", "database"],"credentials":{"host":"localhost","port":"5432","database":"beershop","user":"postgres","password":"postgres"}}]}`
